...
def test_primary_inference_pairs_per_seed_and_budget() -> None:
    ...
    evaluations = (
        _evaluation(
            ...
            (
                ...
                _completed(AllocationPolicy.FABRID_MINIMAX, 0.80, 0.56),
            ),
        ),
        _evaluation(
            1,
            ...
            (
                ...
                _completed(AllocationPolicy.FABRID_MINIMAX, 0.79, 0.54),
            ),
        ),
        _evaluation(
            2,
            ...
            (
                ...
                _completed(AllocationPolicy.FABRID_MINIMAX, 0.80, 0.55),
            ),
        ),
    )
    ...
    assert worst.treatment is AllocationPolicy.FABRID_MINIMAX
