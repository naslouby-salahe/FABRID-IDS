...
class ScoringConfig(BaseModel):
    model_config = ConfigDict(frozen=True, extra="forbid")
    ensemble_score_feature: ColumnName | None = None
...
class SolverConfig(BaseModel):
    ...
    minimax_worst_client_quantile: Probability
...
class FabridMinimaxGateConfig(BaseModel):
    model_config = ConfigDict(frozen=True, extra="forbid")
...
class ExternalReplicationConfig(BaseModel):
    ...
    def protocol_for(self, primary: FabridConfig) -> FabridConfig:
        ...
        return FabridConfig(
            ...
            scoring=ScoringConfig(ensemble_score_feature=None),
        )
